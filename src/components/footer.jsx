    ...
    return (
        <footer className="p-4 sm:p-6 dark:bg-gray-900">
            <div className="md:flex ">
                <div className="lg:w-4/12 sm:w-4/12 xs:w-12/12  mb-6 md:mb-0">
                    <Zoom>
                ...
                <div className="lg:w-8/12 sm:w-8/12 xs:w-12/12  text-left grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 className="mb-3 text-base font-bold text-gray-900 uppercase dark:text-white">Resources</h2>
                        <ul className="text-gray-700 text-sm  dark:text-gray-400">
                            <li className="mb-2">
                    ...
                    <div>
                        <h2 className="mb-3 text-base font-bold text-gray-900 uppercase dark:text-white">Follow us</h2>
                        <ul className="text-gray-700 text-sm dark:text-gray-400">
                            <li className="mb-2">
                    ...
                    <div>
                        <h2 className="mb-3 text-base font-bold text-gray-900 uppercase dark:text-white">Legal</h2>
                        <ul className="text-gray-700 text-sm dark:text-gray-400">
                            <li className="mb-2 ">
            ...
            <div className="sm:items-center mt-3">
                <Fade top>
                    <div>
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#" className="hover:underline">Rockets™</a>. All Rights Reserved.
                        </span>
